const recentWorks = [
    ...
    {
        title: "Product Displayer",
        description: "Display Product and Response Data from Database.",
        techs: ["JS", "React", "Node","Express","MongoDB"],
        img: "/images/mern_product_displayer_response.png"
    },
];
...
const html = recentWorks.map(work =>
    `<div class="bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
        ...
        <a href="https://github.com/zhkir29" target="_blank"
