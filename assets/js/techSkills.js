const techSkills = [
    {
        ...
        skills: [
            ...
            { icon: `<i class="fa-brands fa-php fa-sm text-red-600"></i>`, name: "Python", label: "Junior" },
            { icon: `<i class="fa-brands fa-markdown fa-2xs text-slate-600"></i>`, name: "TypeScript", label: "Junior" }
        ]
    },
    {
        title: "Front-end",
        skills: [
            ...
            { icon: `<i class="fa-solid fa-fire text-red-600"></i>`, name: "CSS Flexbox", label: "Expert" },
            { icon: `<i class="fa-brands fa-bootstrap text-green-600"></i>`, name: "CSS Grid", label: "Expert" },
            { icon: `<i class="fa-solid fa-code fa-xs text-green-600"></i>`, name: "Tailwind", label: "Expert" },
            { icon: `<i class="fa-solid fa-code fa-xs text-green-600"></i>`, name: "Bootstrap", label: "Intermediate" }
        ]
    },
    {
        title: "Back-end",
